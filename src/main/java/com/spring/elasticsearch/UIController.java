...
public class UIController {
    ...
    public String saveProduct(@ModelAttribute("product") ElasticSearchProduct product) throws IOException {
    ...
    public String showFormForUpdate(@PathVariable(value = "id") String id, Model model) throws IOException {
        ...
        ElasticSearchProduct product = elasticSearchQuery.getDocumentById(id);
    ...
    public String showNewEmployeeForm(Model model) {
        ElasticSearchProduct product = new ElasticSearchProduct();
        model.addAttribute("product", product);
